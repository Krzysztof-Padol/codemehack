...
function createInfoMovie(imgSrc,description){
    ...
    image.src = imgSrc;
    text.classList.add('paragraf1');
    text.innerHTML = description;
    naglowek.innerHTML = "Informacje";
...
function createRecMovie(description){
    ...
    text.classList.add('recenzja1');
    container.classList.add('rec');

    naglowek.innerHTML = "Recenzja";
    text.innerHTML = description;
...
function createFilmList(imgSrc){
    ...
    container.classList.add('film__list');
    image.src = imgSrc;
    naglowek.innerHTML = 'Lista filmów';
